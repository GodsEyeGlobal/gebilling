...
<head>
    ...
    @endif
    @isset($title)
    <meta content="{{ isset($title) ? config('app.name', 'GEBilling') . ' - ' . $title : config('app.name', 'GEBilling') }}" property="og:title">
    <meta content="{{ isset($title) ? config('app.name', 'GEBilling') . ' - ' . $title : config('app.name', 'GEBilling') }}" name="title">
    @endisset
    @isset($description)
