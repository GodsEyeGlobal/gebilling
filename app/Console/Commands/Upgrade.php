...
class Upgrade extends Command
{
    ...
    public function handle()
    {
        ...
        // Call update.sh <url>
        $this->line('$upgrader> curl -L "https://raw.githubusercontent.com/godseyeglobal/gebilling/master/update.sh" | bash -s -- --user=' . $user . ' --group=' . $group . ' --url=' . $this->getUrl());
        $process = Process::fromShellCommandline('curl -L "https://raw.githubusercontent.com/godseyeglobal/gebilling/master/update.sh" | bash -s -- --user=' . $user . ' --group=' . $group . ' --url=' . $this->getUrl(), null, null, null, 1200);
