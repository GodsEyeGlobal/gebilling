{{-- extensions/Others/Godsv1AboutPage/Resources/views/livewire/about-page-editor.blade.php --}}

<div class="obs-about-editor space-y-7">
    @php
        // Godsv1 vibe (professional, readable, no "white page" sections)
        $section = 'fi-section';
    ...
    <style>
        ...
        /* Reduce Filament default shadows/outlines for Godsv1 look */
        ...
        <div class="{{ $contentCtn }}">
            <div class="{{ $content }} flex flex-col gap-3 py-1 sm:flex-row sm:items-center sm:justify-between">
                <div class="text-sm text-white/60">
                    Saves to <span class="font-mono text-white/80">settings.key = godsv1.about</span>
                </div>
