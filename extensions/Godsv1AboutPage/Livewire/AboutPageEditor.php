...
namespace Paymenter\Extensions\Others\Godsv1AboutPage\Livewire;
...
class AboutPageEditor extends Component
{
    ...
    public function dehydrate(): void
    {
        ...
        if (config('app.debug')) {
            ...
            if ($bad !== null) {
                logger()->error('Godsv1AboutPage UTF-8 issue at: ' . $bad);
            }
        }
    }
    ...
    {
        return view('godsv1-about-page::livewire.about-page-editor', [
            'publicImagesBase' => $this->publicImagesBase,
        ]);
    }
    ...
    {
        $row = DB::table('settings')->where('key', 'godsv1.about')->value('value');
