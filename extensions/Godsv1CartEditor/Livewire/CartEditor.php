...
namespace Paymenter\Extensions\Others\Godsv1CartEditor\Livewire;
...
class CartEditor extends Component
{
    ...
    {
        $raw = DB::table('settings')->where('key', 'godsv1.cart_editor')->value('value');
    ...
    {
        return view('godsv1-cart-editor::livewire.cart-editor');
    }
}
