...
namespace Paymenter\Extensions\Others\Godsv1FooterEditor\Livewire;
...
{
    /** Setting key */
    public string $settingKey = 'godsv1.footer';
    ...
    {
        return view('godsv1-footer-editor::livewire.footer-editor');
    }
