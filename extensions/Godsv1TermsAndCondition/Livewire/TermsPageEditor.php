...
namespace Paymenter\Extensions\Others\Godsv1TermsAndCondition\Livewire;
...
class TermsPageEditor extends Component
{
    ...
    {
        // This MUST match the namespace you registered in Godsv1TermsAndCondition::boot()
        return view('godsv1-terms-and-condition::livewire.terms-page-editor');
    }

    private function loadConfig(): array
    {
        $row = DB::table('settings')->where('key', 'godsv1.terms')->value('value');
