<x-filament-panels::page>
    <style>
        ...
        .one-mini { height:28px; padding:0 10px; border-radius:10px; border:1px solid rgba(255,255,255,0.12); background: rgba(255,255,255,0.06); color:#fff; font-weight:800; font-size:12px; cursor:pointer; }
        ...
        .one-pill { display:inline-flex; align-items:center; justify-content:center; border-radius:999px; padding:6px 10px; font-size:12px; font-weight:900; border:1px solid rgba(255,255,255,0.10); background: rgba(255,255,255,0.05); color: rgba(255,255,255,0.80); }
    ...
    <div class="one-wrap">
        @livewire('godsv1-terms-page.editor')
    </div>
</x-filament-panels::page>
