{{-- extensions/Others/Godsv1TermsAndCondition/Resources/views/front/terms.blade.php --}}
...
@php
     ...
     * - Otherwise load godsv1.terms from settings and decode JSON.
     */
    if (!isset($cfg) || !is_array($cfg)) {
        $raw = DB::table('settings')->where('key', 'godsv1.terms')->value('value');
        $decoded = null;
