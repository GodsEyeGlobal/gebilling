...
namespace Paymenter\Extensions\Others\Godsv1NavbarEditor\Livewire;
...
{
    /** Setting key */
    public string $settingKey = 'godsv1.navbar';

    /** Options key (stored as JSON) */
    public string $optionsKey = 'godsv1.navbar.options';
    ...
    {
        return view('godsv1-navbar-editor::livewire.navbar-editor');
    }
